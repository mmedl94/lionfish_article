...
In Figure \ref{fig:winteractiv_heatmap}B, we can determine whether for a particular feature by tourists in which clusters.  For example, nearly all tourists who visited museums are grouped in cluster 2, and those who used health facilities are primarily attributed to cluster 4. Some activities, such as relaxing, are popular across all clusters.
