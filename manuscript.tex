...
\title{Interactively Visualizing Multivariate Market Segmentation Using the Novel R Package Lionfish}

%% for pretty printing and a nice hypersummary also set:
\Plainauthor{Matthias Medl, Dianne Cook, Ursula Laa} %% comma-separated
\Plaintitle{Interactively Visualizing Multivariate Market Segmentation Using the Novel R Package Lionfish} %% without formatting
