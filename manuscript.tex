...
In this section, the Austrian Vacation Activities \citep{dolnicar2003winter}, Australian Vacation Activities \citep{cliff2009formative} and Tourist Risk taking \citep{dolnicar2017peer} datasets are analyzed with \pkg{lionfish} to illustrate the software's capabilities. In each example a $k$-means clustering is used for illustration, primarily because this is what was used in the cited work introducing the data. The examples are either binary or likert data which can be considered to be numeric for clustering. Similarly, the choice of number of clusters follows the cited work, and from our observations seems to make a reasonable partition of each data set. 
