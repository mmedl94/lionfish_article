...
Furthermore, \texttt{lionfish} provides an additional demonstration of how \proglang{R} and \proglang{Python} can be integrated to harness the strengths of both programming languages.
