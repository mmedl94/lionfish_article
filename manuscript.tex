...
\caption{The way to examine partitions in high dimensions is to examine linear combinations, with selected groups. The three plots show the best views of the three data sets (A, B, C) for examining the partitioning. }
